...
import (
	...
	"gitlab.com/jacob-ernst/mets/pkg/middleware"
	"gitlab.com/jacob-ernst/mets/pkg/models"
	"gitlab.com/jacob-ernst/mets/pkg/routes"
...
func main() {
	...
	if err != nil {
		...
		if db == nil {
			...
			app.DB = db
			err := app.DB.AutoMigrate(&models.Activity{})
			if err != nil {
	...
	app.Use(func(c *fiber.Ctx) error {
		...
		err := c.Render("errors/404", fiber.Map{"Title": "404 Not Found"})
		if err != nil {
